...
public class Tracker {
    ...
    public static Tracker getInstance() {
        if (single_instance == null)
            single_instance = new Tracker();

        return single_instance;
    }

    /**
     * To start counting the performance
     * TODO: added tracker id so we can measure multiple function
     *
    ...
    public static void start(String trackerId) {
        ...
        logger.info("Performance time {} start {}", trackerId, Tracker.getInstance().map.get(trackerId));
    }
    ...
    public static void stop(String trackerId) {
        ...
        logger.info("Performance time {} finish {} - {} = {} {}", trackerId, end, start, (end - start), Tracker.getCallerClassName());
    }
    ...
    public static String getCallerClassName() {
        ...
        for (int i = 1; i < stElements.length; i++) {
            ...
            if (!ste.getClassName().equals(Tracker.class.getName()) && ste.getClassName().indexOf("java.lang.Thread") != 0) {
