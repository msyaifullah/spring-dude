...
public class CommandLineRunnerBeanOne implements CommandLineRunner {
    ...
    @Autowired
    OrderoService orderoService;

    @Autowired
    POConfigService poConfigService;
...
//        InputStream inputStreamOrder = TypeReference.class.getResourceAsStream("/json/orders.json");
//        try {
//            List<POConfig> orders = mapperOrder.readValue(inputStreamOrder, typeReferenceOrder);
