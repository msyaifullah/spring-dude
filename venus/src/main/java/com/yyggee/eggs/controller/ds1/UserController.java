...
public class UserController {
  ...
  public ResponseEntity<BaseApiResponse> login(
    ...
    SigninResponse token = (basicToken != null)
  ...
  public ResponseEntity<BaseApiResponse> signup(@RequestBody UserRequest user) {
    UserResponse userResponse = modelMapper.map(userService.signup(modelMapper.map(user, User.class)),
        UserResponse.class);
  ...
  public ResponseEntity<BaseApiResponse> signout(
    ...
    if (!isLogin)
      throw new KitchenException("Signout failed", HttpStatus.UNPROCESSABLE_ENTITY);
