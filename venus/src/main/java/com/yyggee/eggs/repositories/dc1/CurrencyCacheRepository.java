...
public class CurrencyCacheRepository implements CacheRepository<Currency> {
    ...
    public Currency save(Currency model) {
        BoundValueOperations<String, Currency> boundValueOperations = this.redisTemplate.boundValueOps(KEY + model.getCode());
    ...
    public Currency findByCode(String code) {
        BoundValueOperations<String, Currency> boundValueOperations = this.redisTemplate.boundValueOps(KEY + code);
